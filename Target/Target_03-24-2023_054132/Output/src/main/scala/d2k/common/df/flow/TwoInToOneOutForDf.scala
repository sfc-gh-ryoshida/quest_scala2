...
trait TwoInToOneOutForDf[IN1, IN2, OUT] extends TwoInToOneOut[IN1, IN2, DataFrame, DataFrame, DataFrame, OUT] with Logging {
...
try
   ...
   final def debug(in1: IN1, in2: IN2)(implicit inArgs: InputArgs) : OUT = run(in1, in2)(inArgs.copy(isDebug = true))
}